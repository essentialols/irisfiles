...
151 tool pages, grouped on the landing page into the categories below (155 HTML pages in total,
counting `index.html`, `about.html`, `privacy.html` and the
`verify-local-file-conversion.html` guide):
...
# Run validation suite (155 pages, SEO meta, JSON-LD, internal links, sitemap)
npm test
...
irisfiles/
  ...
  *.html                  # 151 tool pages (one per tool), 132 of them <from>-to-<to>
  ...
  test/validate.mjs       # Validation suite (155 pages, SEO/links/sitemap/CSP)
